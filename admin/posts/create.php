        ...
        <div class="posts col-9">
            ...
            <div class="row add-post">
                ...
                <form action="create.php" method="post" enctype="multipart/form-data">
                    <div class="col mb-4">
                        <input name="title" value="<?=$title; ?>" type="text" class="form-control" placeholder="Название товара" aria-label="Название товара">
                    </div>
                    <div class="col mb-4">
                        <input name="price" value="<?=$price; ?>" type="text" class="form-control" placeholder="Цена товара" aria-label="Цена товара">
                    </div>
                    <div class="col">
                    ...
                    <div class="col col-6">
                        <button name="add_post" class="btn btn-primary" type="submit">Добавить товар</button>
                    </div>
                </form>
            </div>
        </div>
